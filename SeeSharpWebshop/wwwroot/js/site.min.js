const updateCart=n=>{fetch(`http://localhost:51421/api/cart/${n}`).then(n=>n.json()).then(n=>document.querySelector("span.badge").innerHTML=n)},AddLatestProductToList=()=>{const n=document.querySelector(".row");fetch("http://localhost:51421/api/product").then(n=>n.json()).then(t=>{if(t.length>0){const i=t[t.length-1];console.log(i);n.innerHTML+=`
